...
4. 需要联调时先看 [双后端环境变量与默认值对照](/guide/env-alignment)，再查看“接口规范”“数据库设计”“权限安全”。
5. 准备交付或上线时重点阅读“部署方案”。
6. 如果你要排查按钮显隐、接口 403 或核对前端权限值与后端校验点，再看 [前后端权限码对照](/security/permission-alignment)。
7. 如果你要继续补文档或统一口径，再看 [参考项目与文档改进思路](/guide/reference-projects)。
8. 如果你要按步骤推进这轮修复并持续打勾记录，直接看 [Smoke 修复与功能链条任务板](/guide/repair-task-board)。
